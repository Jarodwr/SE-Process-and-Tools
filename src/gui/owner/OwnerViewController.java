...
public class OwnerViewController {
    ...
    void changeOpeningTimes(ActionEvent event) {
    	...
    	{
			//open the page
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("OwnerOpeningTimes.fxml"));
			mainScreen.getChildren().clear();
			mainScreen.getChildren().add(loader.load());
    ...
    void preferences(ActionEvent event) {
    	...
    	{
			//open the page
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("OwnerPreferences.fxml"));
			mainScreen.getChildren().clear();
			//add to the main screen
			mainScreen.getChildren().add(loader.load());
    ...
    public void init(Stage main, Controller c, User u) {
    	...
    	accent = c.utilities.getBusinessColor(u.getBusinessName());
