package SARJ.BookingSystem.gui.login;

import java.io.IOException;
import java.util.logging.Logger;

import SARJ.BookingSystem.controller.Controller;
import SARJ.BookingSystem.gui.customer.CustomerViewController;
import SARJ.BookingSystem.gui.owner.OwnerViewController;
import SARJ.BookingSystem.gui.register.RegisterBusinessController;
import SARJ.BookingSystem.gui.register.RegisterController;
...
public class LoginController 
{
    	...
    	try {
	    	...
	    	if (u == null) { 
		    	...
		    	main.show();
 	    		...
 	    		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/register/Business.fxml"));
 		    	BorderPane root = loader.load();
 		    	Scene ownerview = new Scene(root, 900, 600);
 				main.setScene(ownerview);
    ...
    void loginSignupClick(ActionEvent event) 
    {
    	try 
    	{
    		...
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/register/Customer.fxml"));
	    	BorderPane root = loader.load();
	    	Scene ownerview = new Scene(root, 900, 600);
			main.setScene(ownerview);
