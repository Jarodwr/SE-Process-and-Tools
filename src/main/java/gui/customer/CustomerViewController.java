...
public class CustomerViewController {
    ...
    void addBooking(ActionEvent event) {
    	...
    	try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/customer/AddBooking.fxml"));
    ...
    void viewBookings(ActionEvent event) {
    	...
    	try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/customer/ViewBooking.fxml"));
			mainScreen.getChildren().clear();
			mainScreen.getChildren().add((Node) loader.load());
