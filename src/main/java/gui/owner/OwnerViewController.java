...
public class OwnerViewController {
    ...
    void addBooking(ActionEvent event) {
    	...
    	try {
			...
			FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/owner/AddBooking.fxml"));
    ...
    void addEmployee(ActionEvent event) 
    {
    	...
    	{
			//open page
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/owner/AddEmployee.fxml"));
			mainScreen.getChildren().clear();
			//add to main screen
			mainScreen.getChildren().add((Node) loader.load());
    ...
    void addService(ActionEvent event) 
    {
    	...
    	{
			//open page
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/owner/AddService.fxml"));
    ...
    void addWorkingTimes(ActionEvent event) 
    {
    	...
    	{
			//open the page
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/owner/ChangeWorkingTimes.fxml"));
			mainScreen.getChildren().clear();
			//add to main screen
			mainScreen.getChildren().add((Node) loader.load());
    ...
    void editEmployeeAvailability(ActionEvent event) 
    {
    	...
    	{
			//open the page
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/owner/AddEmployeeAvailabilities.fxml"));
			mainScreen.getChildren().clear();
    ...
    void logout(ActionEvent event) 
    {
    	...
    	{
    		//open the login page
			FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/login/Login.fxml")); /* TODO replace with page that says "are you sure you want to log out?" */
    ...
    void viewBookings(ActionEvent event) 
    {
    	...
    	{
			//open page
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/owner/ViewBookingSummary.fxml"));
			mainScreen.getChildren().clear();
			mainScreen.getChildren().add((Node) loader.load());
    ...
    void viewWorkingTimes(ActionEvent event) 
    {
    	...
    	{
			//open the page
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/owner/ViewWorkingTimes.fxml"));
			mainScreen.getChildren().clear();
			mainScreen.getChildren().add((Node) loader.load());
